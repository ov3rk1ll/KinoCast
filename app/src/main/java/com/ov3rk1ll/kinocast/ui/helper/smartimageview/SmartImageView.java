...
public class SmartImageView extends ImageView {
    ...
    // Helpers to set image by Item
    public void setImageItem(CoverImage.Request item) {
        setImage(new CoverImage(item));
    }

    public void setImageItem(CoverImage.Request item, SmartImageTask.OnCompleteListener completeListener) {
        setImage(new CoverImage(item), completeListener);
    }

    public void setImageItem(CoverImage.Request item, final Integer fallbackResource) {
        setImage(new CoverImage(item), fallbackResource);
    }

    public void setImageItem(CoverImage.Request item, final Integer fallbackResource, SmartImageTask.OnCompleteListener completeListener) {
        setImage(new CoverImage(item), fallbackResource, completeListener);
    }

    public void setImageItem(CoverImage.Request item, final Integer fallbackResource, final Integer loadingResource) {
        setImage(new CoverImage(item), fallbackResource, loadingResource);
    }

    public void setImageItem(CoverImage.Request item, final Integer fallbackResource, final Integer loadingResource, SmartImageTask.OnCompleteListener completeListener) {
        setImage(new CoverImage(item), fallbackResource, loadingResource, completeListener);
    }
